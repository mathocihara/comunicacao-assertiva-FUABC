    ...
    <>
      ...
      <header className="institutional-header">
        <div className="header-top">
                    <img src={susLogo} alt="logo do sistema único de saúde" className="partner-logo-sus" />
        </div>
        <div className="header-bot">
        <div className="brand-mark">
          <img src={complexoLogo} alt="Logo do Complexo de Saúde de São Caetano do Sul" className="partner-logo" />
          <img src={pmscsLogo} alt="Logo da Prefeitura Municipal de São Caetano do Sul" className="partner-logo" />
           <img src={fundacaologo} alt="Logo da Fundação ABC" className="partner-logo" />
